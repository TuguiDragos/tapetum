...
export function buildTokenColors(y) {
  return [
    ...
    { name: 'Markdown headings', ...S(['markup.heading', 'entity.name.section.markdown'], y.heading, 'bold') },
    { name: 'Markdown heading marks', ...S(['punctuation.definition.heading.markdown'], y.op, 'bold') },
    ...
    { name: 'Markdown bold italic', ...S(['markup.bold markup.italic', 'markup.italic markup.bold'], y.number, 'bold italic') },
    ...
    { name: 'GraphQL declarations', scope: ['entity.name.fragment', 'entity.scalar', 'keyword.fragment',
      'keyword.interface', 'keyword.enum', 'keyword.input', 'keyword.implements', 'keyword.directive',
      'keyword.on', 'keyword.union', 'keyword.scalar', 'keyword.type.graphql'], settings: { foreground: y.keyword, fontStyle: '' } },
    { name: 'Go type keyword', scope: ['keyword.type.go'], settings: { foreground: y.keyword, fontStyle: '' } },
