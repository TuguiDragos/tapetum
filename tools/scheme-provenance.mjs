...
export function tokenColors(p) {
  ...
  return [
    ...
    { name: 'Go type keyword', scope: ['keyword.type.go'], settings: { foreground: dim, fontStyle: '' } },
    ...
    { name: 'Markup heading marks', ...S(['punctuation.definition.heading.markdown'], op, 'bold') },
    ...
    { name: 'Markup strong emphasis', ...S(['markup.bold markup.italic', 'markup.italic markup.bold'], fg, 'bold italic') },
