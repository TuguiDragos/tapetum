...
function controls(t) {
  ...
  return {
    ...
    'scrollbarSlider.background': alphaOf(sliderTone(bg, fg, 2.0), 0.4),
    'scrollbarSlider.hoverBackground': alphaOf(sliderTone(bg, fg, 2.7), 0.6),
    'scrollbarSlider.activeBackground': alphaOf(sliderTone(bg, fg, 3.5), 0.75),
